...
class DailyForecastCell : UITableViewCell {
    ...
    func setup(dailyForecast : DailyForecast) {
        ...
        temperaturesLabel.text = "Temp: \(dailyForecast.minTemperature.description) - \(dailyForecast.maxTemperature.description) C"
        precipitationProbabilityLabel.text = "Precipitation: \(dailyForecast.precipitationProbability?.description ?? "-")%"
