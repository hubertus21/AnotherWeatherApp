...
struct WMOCodeTranslator {
    
    static func describe(wmoCode : Int) -> String {
        wmoCodesDescriptions[wmoCode] ?? "Unknown"
    }
    
    static let wmoCodesDescriptions = [
